...
Igenes <- B$Gene[B$log2Ratio > 0 & B$pIvsII < 0.05]
IIgenes <- B$Gene[B$log2Ratio < 0 & B$pIvsII < 0.05]
# unchangingGenes <- B$Gene[B$log2Ratio < 0.15 & B$log2Ratio > -0.15 & B$pIvsII > 0.1]
