...
def main(args):
	if len(args) != 4: sys.exit("USAGE: python getExpressionForPatientGroupsOfGenes.py KIRC_VHLmutant_specklePatientGroups.txt KIRC_VHLmutant_FPKM_UQ.txt geneName > outfile")
